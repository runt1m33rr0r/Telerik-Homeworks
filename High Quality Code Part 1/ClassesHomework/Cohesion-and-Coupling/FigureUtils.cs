namespace CohesionAndCoupling
{
    ...
    public static class FigureUtils
    {
        ...
        public static double CalcVolume(Figure figure)
        {
        ...
        public static double CalcDiagonalXYZ(Figure figure)
        {
        ...
        public static double CalcDiagonalXY(Figure figure)
        {
        ...
        public static double CalcDiagonalXZ(Figure figure)
        {
        ...
        public static double CalcDiagonalYZ(Figure figure)
        {
