            ...
            do
            {
                if (startGame)
                {
                    Console.WriteLine(
                        ...
                        " Find the cells without mines." +
                        " Enter 'top' to show the score, 'restart' to start a new game and" +
                ...
                {
                    DrawField(mines);
                    Console.Write("\nYou died with a score of {0}! Enter your nickname: ", cellsOpened);
                ...
                if (gameFinished)
                {
                    Console.WriteLine($"Bravo! You succeed to open all {MaxEmptyCells} fields");
                    DrawField(mines);
